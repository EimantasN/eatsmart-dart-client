...
String parameterToString(dynamic value) {
  ...
  if (value is MeasureType) {
    return MeasureTypeTypeTransformer().encode(value).toString();
  }
  if (value is StepInputTypes) {
    return StepInputTypesTypeTransformer().encode(value).toString();
  }
